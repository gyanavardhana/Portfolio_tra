...
import { ArrowRight, Code, Database, FileCode, Server, Terminal, GitBranch, Globe, Tv,Handshake,Container } from "lucide-react";
...
const HeroSection = () => {
  ...
  <SkillCard 
    icon={FileCode}
    title="JavaScript"
    description="Web logic & interactivity"
    className="col-span-2 row-span-2"
  />
   <SkillCard 
    icon={Code}
    title="Python"
    description="Scripting, ML, web backends"
    className="col-span-2 row-span-2"
  />
  ...
  <SkillCard 
    ...
    description="OpenCV, image analysis"
    className="col-span-2 row-span-2"
  />
  ...
  <SkillCard 
    icon={Database}
    title="PostgreSQL"
    description="Relational DB design"
    className="col-span-2 row-span-2"
  />
  <SkillCard 
    icon={GitBranch}
